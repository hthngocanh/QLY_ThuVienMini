...
class BookController extends BaseController
{
    ...
    public function index()
    {
        ...
        $tong_so_sach = $this->bookModel->demDauSach($tu_khoa, $loc_tac_gia, $loc_danh_muc, $loc_nam);
        $tong_so_trang = max(1, (int)ceil($tong_so_sach / $so_sach_moi_trang));
        $danh_sach_sach = $this->bookModel->layDanhSachDauSach($tu_khoa, $loc_tac_gia, $loc_danh_muc, $loc_nam, $so_sach_moi_trang, $offset);
